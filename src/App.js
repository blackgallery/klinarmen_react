    ...
    <Router>
      <ScrollToTop>
        <Switch>
          ...
          component={Service}
          /> 
          <Route path={`${process.env.PUBLIC_URL + '/service/:serviceID'}`} component={SingleService}/>
          <Route path={`${process.env.PUBLIC_URL + '/gallery/:galleryID'}`} component={SingleGallery}/>
