            ...
            <section className="single-work-page">
                <div className="container">  
                    ...
                    <div className="row"> 
                        <div className="col-sm-12 col-xs-12">
                            <div className="row">
                                <div className="portfolioitem col-sm-12">
                                    <div className="carousel slide" data-ride="carousel" id="blog-post-slider">
                                        <SlickSlider settings={{
                                            className: "service-details-thumb",
                                            arrows: true,
                                            dots: false,
                                            nextArrow: <i class="arrow_left "></i>,
                                            prevArrow: <i class="arrow_left"></i>
                                        }}>
                                        {
                                        gallery.previewImages.map((previewImg, indx) => (
                                            <div key={indx}>
                        ...
                        <div className="col-sm-12 col-xs-12">
                            <div className="row">
                                <div className="portfoliodesc col-sm-8">
                                ...
                                <div className="portfoliodesc portfolio-single-detail col-sm-4">
                                <div className="project-details">
